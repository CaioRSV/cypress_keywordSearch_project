...
let palavraChave = "chatgpt"


let filterTerms = ['ft.', '!', '@', '?', '&', '|', '#', '(', ')', '[', ']', '*', '"', '/', '-', '–', '=', '',
'DA', 'DE', 'DO', 'NA', 'NO', 'OF', 'THE', 'É', 'O', 'A', 'E', 'IMAGENS', 'DESCRIÇÃO',
'#01', '#02', '#03', '#04', '#05'];
